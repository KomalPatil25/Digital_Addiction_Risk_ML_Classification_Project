...
# with c1:
#     Screen_Time_Hours = st.number_input("Screen Time (hrs)", min_value=0.0, max_value=16.0, value=6.0)
#     Social_Media_Hours = st.number_input("Social Media (hrs)", min_value=0.0, max_value=12.0, value=3.0)
...
# with c3:
#     App_Unlocks_Per_Day = st.number_input("App Unlocks (Per Day)", min_value=0, max_value=300, value=60)
